    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient_cid', models.UUIDField(blank=True, help_text='Patient ID prescribed by the associated center', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default', models.BooleanField(default=True, help_text='If True it will apply to all array data samples.')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('array_data_file', models.FileField(help_text='File containing rows of array data for the corresponding meta data file.', upload_to='raw_data/', validators=[django.core.validators.FileExtensionValidator(['csv', 'xlsx', 'jsonl'])])),
                ('center', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='uploader.center')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bio_sample', to='uploader.biosampletype', verbose_name='Sample Type')),
                ('visit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bio_sample', to='uploader.visit')),
            ],
            options={
                'db_table': 'bio_sample',
                'get_latest_by': 'updated_at',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.FileField(max_length=256, upload_to='array_data/', validators=[django.core.validators.FileExtensionValidator(['csv', 'xlsx', 'jsonl'])], verbose_name='Array data file')),
                ('bio_sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='array_data', to='uploader.biosample')),
                ('instrument', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='array_data', to='uploader.instrument')),
                ('measurement_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='array_data', to='uploader.arraymeasurementtype', verbose_name='Measurement type')),
            ],
            options={
                'verbose_name': 'Array Data',
                'verbose_name_plural': 'Array Data',
                'db_table': 'array_data',
                'get_latest_by': 'updated_at',
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('array_data', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='qc_annotation', to='uploader.arraydata')),
            ],
            options={
