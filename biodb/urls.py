...
urlpatterns = [
    ...
    path(
        ...
        decorator_include(
            user_passes_test(
                lambda x: (x.is_active and x.is_staff)
                and (x.is_superuser or getattr(x, "is_sqluser_view", False) or getattr(x, "is_sqluser_change", False)),
    ...
    path(
        ...
        auth_views.PasswordResetView.as_view(
            from_email=settings.EMAIL_FROM, extra_context={"site_header": admin.site.site_header}
        ),
