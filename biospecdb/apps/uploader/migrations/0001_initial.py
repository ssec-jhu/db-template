    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('days_observed', models.IntegerField(blank=True, default=None, help_text='Applies to all observations unless otherwise stated', null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Days of symptoms onset')),
