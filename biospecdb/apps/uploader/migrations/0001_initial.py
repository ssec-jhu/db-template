# Generated by Django 4.2.1 on 2023-10-08 18:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_class', models.CharField(choices=[('BOOL', 'Bool'), ('STR', 'Str'), ('INT', 'Int'), ('FLOAT', 'Float')], default='BOOL', max_length=128)),
                ('center', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='uploader.center')),
            ],
            options={
                'get_latest_by': 'updated_at',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('center', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='uploader.center')),
            ],
            options={
                'get_latest_by': 'updated_at',
            },
