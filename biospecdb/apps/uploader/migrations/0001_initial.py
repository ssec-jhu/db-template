...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('user', '0002_alter_center_country'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Center',
            fields=[
                ('center_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='user.center')),
            ],
            bases=('user.center',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_class', models.CharField(choices=[('BOOL', 'Bool'), ('STR', 'Str'), ('INT', 'Int'), ('FLOAT', 'Float')], default='BOOL', max_length=128)),
                ('center', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user.center')),
            ],
        ),
        migrations.CreateModel(
            name='Instrument',
